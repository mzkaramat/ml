 ...
 *
 */
public class LinRegOnlineLearner implements SimpleOnlineLearner {
  ...
  public LinRegOnlineLearner(OnlineLearner.Params params) {
  ...
  public boolean update(LabeledVector x) {
    ...
    double loss = x.getLabel() - weights.innerProduct(x);
